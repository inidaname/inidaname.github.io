...
const routes = [{ path: '', component: _posts_component__WEBPACK_IMPORTED_MODULE_2__["PostsComponent"] }];
...
PostsComponent.ɵfac = function PostsComponent_Factory(t) { return new (t || PostsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_scullyio_ng_lib__WEBPACK_IMPORTED_MODULE_1__["ScullyRoutesService"])); };
PostsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PostsComponent, selectors: [["app-posts"]], decls: 5, vars: 3, consts: [[1, "w-screen", "py-10", "h-auto", "box-border", "mx-auto"], [1, "w-4/5", "bg-white", "justify-around", "shadow-md", "rounded", "items-center", "sm:w-4/5", "box-border", "lg:w-3/4", "flex", "flex-col", "mx-auto", "border"], ["class", "shadow-md my-5 p-4", 3, "ngClass", 4, "ngFor", "ngForOf"], [1, "shadow-md", "my-5", "p-4", 3, "ngClass"], [3, "routerLink"], [1, "text-2xl", "font-bold", "mt-3", "px-3", "lg:text-3xl"], [1, "w-full", "px-4", "sm:w-full", "lg:w-1/2"]], template: function PostsComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["NgForOf"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["NgClass"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterLinkWithHref"]], pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["AsyncPipe"]], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3Bvc3RzL3Bvc3RzLmNvbXBvbmVudC5zY3NzIn0= */"] });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](PostsModule, { declarations: [_posts_component__WEBPACK_IMPORTED_MODULE_3__["PostsComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        _posts_routing_module__WEBPACK_IMPORTED_MODULE_2__["PostsRoutingModule"]] }); })();
